export default {
  ...
  work: {
    ...
    cheers: {
      ...
      responsibility2:
        "Successfully migrated the client's web application from its existing platform to a new, more efficient environment, scalability, and maintainability",
      responsibility3:
        "Created reusable and responsive components based on provided designs",
      responsibility4:
